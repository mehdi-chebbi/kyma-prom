...
type Schema struct {
        ...
        k8sClient prometheus.KubernetesClientInterface
        gitea     prometheus.GiteaClientInterface
        config    *config.Config
        logger    *logrus.Logger
}

func NewSchema(k8sClient prometheus.KubernetesClientInterface, giteaClient prometheus.GiteaClientInterface, cfg *config.Config, logger *logrus.Logger) *Schema {
        s := &Schema{
                k8sClient: k8sClient,
                gitea:     giteaClient,
                config:    cfg,
