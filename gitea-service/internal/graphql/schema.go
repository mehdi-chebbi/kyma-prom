...
func NewSchema(giteaService *gitea.Service, ldapClient *ldap.Client, giteaClient *gitea.Client, collabService *gosync.CollabService, cfg *config.Config, logger *logrus.Logger) *Schema {
	s := &Schema{
