...
const GraphanaIcon = ({ title, className, ...props }: IconProps) => (
  <svg
    className={className}
    width="16"
    height="16"
  ...
  >
    ...
    <defs>
      <linearGradient id="SVGID_1_" x1="175.5" y1="30%" x2="175.5" y2="99%">
        <stop offset="0" stopColor="#F05A28" />
        <stop offset="1" stopColor="#FBCA0A" />
      </linearGradient>
    </defs>
<path fill="url(#SVGID_1_)" d="M342,161.2c-0.6-6.1-1.6-13.1-3.6-20.9c-2-7.7-5-16.2-9.4-25c-4.4-8.8-10.1-17.9-17.5-26.8
